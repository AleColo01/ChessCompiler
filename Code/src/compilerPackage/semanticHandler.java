...
public class semanticHandler {
	...
	public static int PREAMBLE_DRAW_ERROR = 21; //il preambolo parte da una situazione patta OK
	public static int STARTING_KING_CHECK_ERROR = 22; //il re di chi non inizia è in scacco 
	public static int STARTING_TURN_ERROR = 23; //il colore di chi iniza non è corretto OK 
